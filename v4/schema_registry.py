...
NORMALIZED_SCHEMA = {
    ...
    "src_port":float,"dst_port":float,
    "protocol":str,"timestamp":float,
    "duration":float,
    "src_bytes":float,"dst_bytes":float,
    "src_pkts":float,"dst_pkts":float,
    "tcp_flags":float,"payload_size":float,
    "connection_state":str,"label":str,
}
...
DATASET_SCHEMAS = {
    "TON_IOT":{
        ...
        "tcp_flags":None,"payload_size":"src_bytes",
        "connection_state":"conn_state",
        "label":"type","benign_label":"normal",
    },
    "CIC_IOT":{
        "src_ip":None,"dst_ip":None,
        "src_port":None,"dst_port":None,
        "protocol":"Protocol Type","timestamp":None,
        "duration":"flow_duration",
        "src_bytes":"Srate","dst_bytes":"Drate",
        "src_pkts":"Rate","dst_pkts":"Drate",
        "tcp_flags":"fin_flag_number",
        "payload_size":"Header_Length",
        "connection_state":None,
        "label":"label","benign_label":"BenignTraffic",
    },
    "UNSW_NB15":{
        "src_ip":"srcip","dst_ip":"dstip",
        "src_port":"sport","dst_port":"dsport",
        "protocol":"proto","timestamp":"stime",
        "duration":"dur",
        "src_bytes":"sbytes","dst_bytes":"dbytes",
        "src_pkts":"spkts","dst_pkts":"dpkts",
        "tcp_flags":"swin","payload_size":"smean",
        "connection_state":"state",
        "label":"attack_cat","benign_label":"Normal",
    },
    "BOT_IOT":{
        "src_ip":"saddr","dst_ip":"daddr",
        "src_port":"sport","dst_port":"dport",
        ...
        "payload_size":"mean",
        "connection_state":"state",
        "label":"category","benign_label":"Normal",
    },
    "CICIDS2017":{
        "src_ip":None,"dst_ip":None,
        "src_port":None,
        "dst_port":"Destination Port",
        "protocol":None,"timestamp":None,
        ...
        "connection_state":None,
        "label":"Label","benign_label":"BENIGN",
    },
    "AUTO":{"label":None,"benign_label":None},
}
...
def detect_dataset(df):
    ...
    signatures = {
        "TON_IOT"   :{"saddr","daddr","proto",
                      "type","src_pkts","dst_pkts"},
        "CIC_IOT"   :{"label","header_length",
                      "protocol type",
                      "flow_duration","srate"},
        "UNSW_NB15" :{"srcip","dstip","sbytes",
                      "dbytes","attack_cat","dur"},
        "BOT_IOT"   :{"saddr","daddr","category",
                      "subcategory","pkseqid",
                      "spkts","dpkts"},
        "CICIDS2017":{"destination port",
                      "flow duration",
                      "total fwd packets",
                      "fin flag count","label"},
    }
    best_match,best_score = "AUTO",0
